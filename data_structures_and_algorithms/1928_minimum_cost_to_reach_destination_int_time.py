...
class Solution:
    def __edgesToWeightedGraph(self, edges: List[List[int]], n: int):
    ...
    def __findNodeWithLowestCost(self, costs, processed):
        nodeWithLowestCost = None
    ...
    def __buildPath(self, parents, start, end):
        path = []
        current = end
    ...
    def __calculatePathWeight(self, path, graph):        
        total_weight = 0
